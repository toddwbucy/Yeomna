...
| Blocked by | rulings R1 and R2 below |
...
| # | Ruling | State |
|---|---|---|
| R1 | Q2 graph isolation | Recommendation delivered (graph_id column, one table set, partition-by-graph as measured graduation). Awaiting Todd |

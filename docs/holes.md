...
| Next | **Reordered 2026-09-10 by Todd**: Phase 7's contract-born CLI tree with H8's tools commands, then the native embedder (H4), then hybrid query, and **the WeaverTools KG stand-up last**, because standing up their graph touches their repository and their deployment and wants a WeaverTools session in the loop rather than this one acting alone |

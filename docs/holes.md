...
| Next | **Phase 7 alone**: the contract-born per-verb CLI tree with H8's tools commands, in epic #37. Then, off H2's path, R21's remaining items: the WeaverTools KG stand-up, the native embedder (H4), and hybrid query |
